...
const SEED_TEXTS: PatristicText[] = [
  // Clement of Rome
  {
    ...
    topics: ['Holy Fathers', 'Holy Trinity', 'Spiritual Life', 'Church History'],
  ...
  // Ignatius of Antioch
  {
    ...
    chapterOrHomily: null,
    topics: ['Holy Fathers', 'Holy Trinity', 'Church History'],
    source: 'ANF Vol. 1, Philip Schaff ed. (CCEL)',
    sortOrder: 1,
  ...
  },
  {
    ...
    chapterOrHomily: null,
    topics: ['Holy Fathers', 'Spiritual Life', 'Church History'],
    source: 'ANF Vol. 1, Philip Schaff ed. (CCEL)',
    sortOrder: 3,
  ...
  // Justin Martyr
  {
    ...
    chapterOrHomily: null,
    topics: ['Holy Fathers', 'Apologetics', 'Holy Scripture'],
    source: 'ANF Vol. 1, Philip Schaff ed. (CCEL)',
    sortOrder: 1,
  ...
  // Irenaeus of Lyon
  {
    ...
    chapterOrHomily: 1,
    topics: ['Holy Fathers', 'Holy Trinity', 'Apologetics'],
    source: 'ANF Vol. 1, Philip Schaff ed. (CCEL)',
    sortOrder: 1,
  ...
  },
  {
    ...
    workTitle: 'Against Heresies',
    chapterOrHomily: 1,
    topics: ['Holy Fathers', 'Holy Scripture', 'Church History'],
    source: 'ANF Vol. 1, Philip Schaff ed. (CCEL)',
    sortOrder: 2,
  ...
  // Basil the Great
  {
    ...
    chapterOrHomily: 1,
    topics: ['Holy Fathers', 'Holy Trinity', 'Spiritual Life'],
  ...
  // Gregory of Nazianzus
  {
    ...
    chapterOrHomily: 27,
    topics: ['Holy Fathers', 'Holy Trinity'],
  ...
  },
  {
    ...
    workTitle: 'Orations',
    chapterOrHomily: 38,
    topics: ['Holy Fathers', 'Feast Days/Fast Days', 'Holy Trinity'],
    source: 'NPNF Series II Vol. 7, Philip Schaff ed. (CCEL)',
    sortOrder: 2,
  ...
  // John Chrysostom
  {
    ...
    chapterOrHomily: 1,
    topics: ['Holy Fathers', 'Holy Scripture', 'Divine Liturgy'],
  ...
  },
  {
    ...
    chapterOrHomily: 1,
    topics: ['Holy Fathers', 'Church History', 'Spiritual Life'],
  ...
  },
  {
    ...
    workTitle: 'On Prayer',
    chapterOrHomily: null,
    topics: ['Holy Fathers', 'Spiritual Life', 'Divine Liturgy'],
    source: 'NPNF Series I Vol. 9, Philip Schaff ed. (CCEL)',
    sortOrder: 3,
  ...
  },
  {
    ...
    chapterOrHomily: 1,
    topics: ['Holy Fathers', 'Iconography', 'Apologetics'],
    source: 'NPNF Series II Vol. 9, Philip Schaff ed. (CCEL)',
    sortOrder: 3,
  ...
  // Dionysius the Areopagite (extra to reach 20+)
  {
    ...
    chapterOrHomily: 1,
    topics: ['Holy Fathers', 'Divine Liturgy', 'Spiritual Life'],
